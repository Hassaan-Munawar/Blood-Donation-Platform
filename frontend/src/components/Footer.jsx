        ...
        <div className="grid grid-cols-1 place-items-center md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className='text-center'>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-gray-300">Email Marketing</a></li>
              <li><a href="#" className="hover:text-gray-300">Campaigns</a></li>
              <li><a href="#" className="hover:text-gray-300">Branding</a></li>
              <li><a href="#" className="hover:text-gray-300">Offline</a></li>
            </ul>
          </div>
